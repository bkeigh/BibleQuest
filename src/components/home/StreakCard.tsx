  ...
  return (
    ...
    >
      ...
      <span className="flex h-[4.5rem] items-end justify-center">
        <ArtIcon name={candleStage(days)} size={68} animate={lit} />
      </span>
      <span className="mt-1 font-art-label text-[0.875rem] leading-none uppercase tracking-[0.05em] text-gilt max-[430px]:text-[0.6875rem] max-[430px]:leading-tight max-[430px]:tracking-[0.03em]">
